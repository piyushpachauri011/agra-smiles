  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero:
          "bg-primary text-primary-foreground shadow-lg hover:shadow-glow hover:scale-[1.03] hover:bg-primary/90 active:scale-[0.98] text-base px-8 py-6",
        heroOutline:
          "border-2 border-primary/30 bg-transparent text-foreground hover:bg-primary/10 hover:border-primary text-base px-8 py-6",
        navCta:
          "bg-primary text-primary-foreground rounded-full px-6 hover:bg-primary/90 hover:shadow-md hover:scale-[1.02] active:scale-[0.98]",
      },
      size: {
